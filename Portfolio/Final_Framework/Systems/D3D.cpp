...
std::vector<D3DEnumAdapterInfo *> D3D::apapterInfos;
...
void D3D::EnumerateAdapters()
{
	...
	while (true)
	{
		...
		D3DEnumAdapterInfo* adapter_info = Debug_new D3DEnumAdapterInfo();
...
bool D3D::EnumerateAdapterOutput(D3DEnumAdapterInfo* adapter_info)
{
	...
	D3DEnumOutputInfo* output_info = Debug_new D3DEnumOutputInfo();
	...
	display_modes = Debug_new DXGI_MODE_DESC[num_modes];
	...
	SAFE_DELETE_ARRAY(display_modes);
