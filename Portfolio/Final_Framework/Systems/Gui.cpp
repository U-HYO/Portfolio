...
void Gui::Update()
{
	...
	if (ImGui::Button("ShowDemo")) bShowDemo = !bShowDemo;
}
...
void Gui::RenderText(float x, float y, std::string content)
{
	GuiText text;
...
void Gui::RenderText(float x, float y, float r, float g, float b, std::string content)
{
	GuiText text;
	text.Position = D3DXVECTOR2(x, y);
...
void Gui::RenderText(D3DXVECTOR2 position, D3DXCOLOR color, std::string content)
{
	GuiText text;
