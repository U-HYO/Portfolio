...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (ImGui::CollapsingHeader("Configuration"))
    {
        ...
        if (ImGui::TreeNode("Configuration##2"))
        {
            ...
            if (io.ConfigFlags & ImGuiConfigFlags_NoMouse) // CreateShaderResourceView a way to restore this flag otherwise we could be stuck completely!
            {
            ...
            if (io.ConfigFlags & ImGuiConfigFlags_DockingEnable)
            {
                ...
                ImGui::SameLine(); HelpMarker("CreateShaderResourceView a docking node and tab-bar on single floating windows.");
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Plots Widgets"))
    {
        ...
        // CreateShaderResourceView a dummy array of contiguous float values to plot
        ...
        while (refresh_time < ImGui::GetTime()) // CreateShaderResourceView dummy data at fixed 60 hz rate for the demo
        {
...
static void ShowDemoWindowColumns()
{
    ...
    // CreateShaderResourceView multiple items in a same cell before switching to next column
...
void ShowExampleAppDocuments(bool* p_open)
{
    ...
    {
        Target_None,
        Target_Tab,                 // CreateShaderResourceView documents as local tab into a local tab bar
        Target_DockSpaceAndWindow   // CreateShaderResourceView documents as regular windows, and create an embedded dockspace
    };
    ...
    else if (opt_target == Target_DockSpaceAndWindow)
    {
        if (ImGui::GetIO().ConfigFlags & ImGuiConfigFlags_DockingEnable)
        {
            ...
            // CreateShaderResourceView a DockSpace node where any window can be docked
            ImGuiID dockspace_id = ImGui::GetID("MyDockSpace");
            ImGui::DockSpace(dockspace_id);

            // CreateShaderResourceView Windows
            for (int doc_n = 0; doc_n < app.Documents.Size; doc_n++)
            {
                MyDocument* doc = &app.Documents[doc_n];
                if (!doc->Open)
