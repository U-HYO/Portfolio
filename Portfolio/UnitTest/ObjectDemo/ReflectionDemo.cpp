...
void ReflectionDemo::Init()
{
	...
	shader = Debug_new Shader(L"61_Reflection.fxo");
	...
	reflection = Debug_new Reflection(shader, mirrorPlane->GetTransform(0));
}

void ReflectionDemo::Release()
{
	SAFE_DELETE(shader);
	SAFE_DELETE(shadow);
