...
void DepthBufferDemo::Init()
{
	...
	shader = Debug_new Shader(L"51_DepthBuffer.fxo");
...
void DepthBufferDemo::PreRender()
{
	//Shadow
	{
		shadow->PreRender();
...
void DepthBufferDemo::PointLights()
{
	PointLight light;
	light =
	{
...
void DepthBufferDemo::SpotLights()
{
	SpotLight light;
	light =
	{
...
void DepthBufferDemo::Pass(UINT _val)
{
