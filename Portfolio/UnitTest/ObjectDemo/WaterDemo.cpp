...
void WaterDemo::Init()
{
	...
	terrain = Debug_new Terrain(shader, L"../../_Textures/Terrain/Gray256.png");
	...
	water = Debug_new Water(Water::InitDesc{ shader, 125, L"Terrain/Gray256.png", 0, 0 });
	water->GetTransform()->SetPosition(128, 5, 128);
...
void WaterDemo::Update()
{
	...
	Vector3 position;
	airplane->GetTransform(0)->GetPosition(&position);
	...
	airplane->GetTransform(0)->SetPosition(position);
