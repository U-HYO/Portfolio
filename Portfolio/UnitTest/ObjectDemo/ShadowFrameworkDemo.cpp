...
void ShadowFrameworkDemo::Init()
{
	...
	shader = Debug_new Shader(L"53_Framework.fxo");
...
void ShadowFrameworkDemo::Release()
{
	SAFE_DELETE(shader);
	SAFE_DELETE(shadow);
...
void ShadowFrameworkDemo::Paladin()
{
...
void ShadowFrameworkDemo::Pass(UINT _val)
{
